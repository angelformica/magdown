...
class WebController extends Controller
{
    public static function index(){
        ...
        $magazines = DB::table('magazines')->orderBy('created_at','desc')->paginate(50);
    ...
    public static function showLang($language_name){
        ...
        $magazines = DB::table('magazines')->where('language_id','=',$language->id)->orderBy('publication_date','desc')->paginate(20);
